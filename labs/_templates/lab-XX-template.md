...
- **S1 — TODO: Scenario name**: Brief description of what this scenario tests
- **S2 — TODO: Scenario name**: Brief description of what this scenario tests
...
```sql
SELECT COUNT(*) FROM TODO_table_name;
```

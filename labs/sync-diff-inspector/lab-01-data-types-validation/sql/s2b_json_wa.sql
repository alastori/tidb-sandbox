-- S2B: JSON compare with collation aligned to utf8mb4_bin

SET NAMES utf8mb4;

DROP TABLE IF EXISTS s2b_json_test_wa;

CREATE TABLE s2b_json_test_wa (
    id INT PRIMARY KEY AUTO_INCREMENT,
    json_col JSON,
    description VARCHAR(100) COLLATE utf8mb4_bin
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

INSERT INTO s2b_json_test_wa (json_col, description) VALUES
    ('{}', 'Empty object'),
    ('[]', 'Empty array'),
    ('null', 'JSON null'),
